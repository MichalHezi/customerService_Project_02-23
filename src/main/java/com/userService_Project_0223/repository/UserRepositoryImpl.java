...
public class UserRepositoryImpl implements UserRepository {
    ...
    public String updateUserLastName(int id, String lastName) {
        String sql = "UPDATE " + Constants.USER_TABLE_NAME + " SET last_name = ? WHERE id = ?";
    ...
    public String updateUserEmail(int id, String email) {
        String sql = "UPDATE " + Constants.USER_TABLE_NAME + " SET email = ? WHERE id = ?";
    ...
    public Integer updateUserAge(int id, Integer age) {
        String sql = "UPDATE " + Constants.USER_TABLE_NAME + " SET age = ? WHERE id = ?";
        return jdbcTemplate.update(sql,age,id);
    }

    @Override
    public String updateUserAddress(int id, String address) {
        String sql = "UPDATE " + Constants.USER_TABLE_NAME + " SET address = ? WHERE id = ?";
    ...
    public List<User> getAllUsers() {
        String sql = "SELECT * FROM " + Constants.USER_TABLE_NAME;
        return jdbcTemplate.query(sql,new UserMapper());
    }

    @Override
    public List<String> getAllUserNames() {
        String sql = "SELECT first_name FROM " + Constants.USER_TABLE_NAME;
